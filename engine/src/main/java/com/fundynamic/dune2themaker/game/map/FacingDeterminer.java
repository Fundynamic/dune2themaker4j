...
public class FacingDeterminer {
    ...
    private static final TerrainFacing[] FACINGS = {
            ...
            TerrainFacing.LEFT,                 // 0x0001
            TerrainFacing.BOTTOM,               // 0x0010
            TerrainFacing.BOTTOM_LEFT,          // 0x0011
            TerrainFacing.RIGHT,                // 0x0100
            TerrainFacing.RIGHT_LEFT,           // 0x0101
            TerrainFacing.RIGHT_BOTTOM,         // 0x0110
            TerrainFacing.RIGHT_BOTTOM_LEFT,    // 0x0111
            TerrainFacing.TOP,                  // 0x1000
            TerrainFacing.TOP_LEFT,             // 0x1001
            TerrainFacing.TOP_BOTTOM,           // 0x1010
            TerrainFacing.TOP_BOTTOM_LEFT,      // 0x1011
            TerrainFacing.TOP_RIGHT,            // 0x1100
            TerrainFacing.TOP_RIGHT_LEFT,       // 0x1101
            TerrainFacing.TOP_RIGHT_BOTTOM,     // 0x1110
